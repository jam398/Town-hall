        ...
        <div className="max-w-swiss mx-auto px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid lg:grid-cols-12 gap-8 mb-12">
            <div className="lg:col-span-6">
              ...
              <div className="h-16 bg-swiss-light w-48 mb-6" />
            </div>
        ...
        <div className="max-w-swiss mx-auto px-6 lg:px-8 pb-16 lg:pb-24">
          <div className="grid lg:grid-cols-12 gap-0 bg-swiss-light overflow-hidden h-[400px]">
            ...
            <div className="lg:col-span-8 p-12">
              ...
              <div className="h-4 bg-neutral-300 w-24 mb-4" />
              <div className="h-10 bg-neutral-300 w-3/4 mb-4" />
              <div className="h-4 bg-neutral-300 w-full mb-6" />
              <div className="grid grid-cols-3 gap-4">
                <div className="h-4 bg-neutral-300" />
                <div className="h-4 bg-neutral-300" />
                <div className="h-4 bg-neutral-300" />
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-swiss-border">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-swiss-white p-6 lg:p-8 text-center">
                <div className="h-10 bg-swiss-light w-20 mx-auto mb-2" />
                <div className="h-4 bg-swiss-light w-24 mx-auto" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-swiss mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-swiss-white border border-swiss-border h-80">
                <div className="h-1 bg-swiss-light" />
                <div className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="h-4 bg-swiss-light w-full" />
                    <div className="h-4 bg-swiss-light w-3/4" />
                  </div>
                </div>
              </div>
            ))}
